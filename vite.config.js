...
function previewThinkingCalls() {
  ...
  return [
    ...
    {
      turn_id: "9d5db6937f765921b2d6cbe0773e5111",
      call_id: "laundry-cues-selection",
      created_at: at(0, 9),
      stage: "topic_selection",
      round: 1,
      model: "deepseek-v4-flash",
      tools: ["select_topics"],
      reasoning_chars: 1160,
      excerpt: "从候选聊天中筛出与洗衣提醒约定直接相关的主题。",
      reasoning: "当前问题需要核对洗衣完成后的提醒约定，以及刚才 Webhook 的实际处理。\n\n候选主题里只有「衣服洗好了」同时覆盖提醒、静默处理和送达结果，其他日常聊天与本轮无关。保留这个主题，避免把无关 Episode 带进上下文。",
    },
    {
      turn_id: "9d5db6937f765921b2d6cbe0773e5111",
      call_id: "laundry-cues-admit",
      created_at: at(0, 9, 30),
      stage: "episode_cue_admit",
      round: 1,
      model: "deepseek-v4-flash",
      tools: ["episode_cue_admit"],
      reasoning_chars: 980,
      excerpt: "逐条核对检索线索，确认提醒约定和静默结果都有原文依据。",
      reasoning: "逐条检查候选线索的来源：\n\n「洗衣完成后根据当前对话决定是否提醒」与老师本轮追问相符；「Webhook 报告完成，Momoi 选择静默」有工具记录支持；「未发送提醒，老师随后追问原因」也能由事件与后续消息对应。三条线索均有来源依据，准入。",
    },
    {
      turn_id: "9d5db6937f765921b2d6cbe0773e5111",
