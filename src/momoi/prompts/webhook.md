...
- If those checks leave external work to perform, first send one short natural acknowledgement bubble with `send_bubbles`; then run the first `curl` batch. This is an owner-visible progress beat, not a promise of success.
